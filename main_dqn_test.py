...
class Agent:
    ...
    def save_models(self, path):
        ...
        torch.save({
            ...
            'replay_buffer_counter': self.replay_buffer_couter,
    ...
    def load_models(self, path):
        ...
        self.replay_buffer_couter = checkpoint['replay_buffer_counter']
...
if __name__ == '__main__':
    ...
    for i in range(n_episodes):
        ...
        if (i+1) % checkpoint_interval == 0:
            checkpoint_path = os.path.join("DQN_Checkpoints", f"checkpoint_episode_{i+1}.pt")
    ...
    final_checkpoint_path = os.path.join("DQN_Checkpoints", "final_model.pt")
    agent.save_models(final_checkpoint_path)
